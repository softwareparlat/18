...
export const budgetNegotiations = pgTable("budget_negotiations", {
  ...
  status: text("status", { enum: ["pending", "accepted", "rejected", "countered"] }).default("pending").notNull(),
  createdAt: timestamp("created_at").defaultNow().notNull(),
  respondedAt: timestamp("responded_at"),
});

export type BudgetNegotiation = typeof budgetNegotiations.$inferSelect;
export type InsertBudgetNegotiation = typeof budgetNegotiations.$inferInsert;
